...
describe('Authenticate User', function () {
    it('should be able to authenticate', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, createUser, authenticateUser, user, authenticate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUsersRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    createUser = new CreateUserService_1.default(fakeAppointmentsRepository, fakeHashProvider);
                    authenticateUser = new AuthenticateUserService_1.default(fakeAppointmentsRepository, fakeHashProvider);
    ...
    it('should not be able to authenticate with a non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, authenticateUser;
        return __generator(this, function (_a) {
            fakeAppointmentsRepository = new FakeUsersRepository_1.default();
            fakeHashProvider = new FakeHashProvider_1.default();
            authenticateUser = new AuthenticateUserService_1.default(fakeAppointmentsRepository, fakeHashProvider);
    ...
    it('should not be able to authenticate with a existing user and wrong passworf', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, authenticateUser, createUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUsersRepository_1.default();
