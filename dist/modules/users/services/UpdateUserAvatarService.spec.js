...
describe('UpdateUserAvatar', function () {
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeStorageProvider, updateAvatarService, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeStorageProvider = new FakeStorageProvider_1.default();
                    updateAvatarService = new UpdateUserAvatarService_1.default(fakeUsersRepository, fakeStorageProvider);
    ...
    it('should not be able to update avatar from non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUsersRepository, fakeStorageProvider, updateAvatarService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUsersRepository = new FakeUsersRepository_1.default();
                    fakeStorageProvider = new FakeStorageProvider_1.default();
                    updateAvatarService = new UpdateUserAvatarService_1.default(fakeUsersRepository, fakeStorageProvider);
                    return [4 /*yield*/, expect(updateAvatarService.execute({
...
it('should delete old avatar when updating to a new one', function () { return __awaiter(void 0, void 0, void 0, function () {
    var fakeUsersRepository, fakeStorageProvider, deleteFile, updateAvatarService, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                fakeUsersRepository = new FakeUsersRepository_1.default();
