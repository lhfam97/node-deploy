...
describe('CreateAppointment', function () {
    it('should be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, createUserService, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUsersRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    createUserService = new CreateUserService_1.default(fakeAppointmentsRepository, fakeHashProvider);
    ...
    it('should not be able to create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeAppointmentsRepository, fakeHashProvider, createUserService;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeAppointmentsRepository = new FakeUsersRepository_1.default();
